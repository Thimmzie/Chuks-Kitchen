  ...
  return (
    <div className="lg:grid lg:grid-cols-2 lg:h-[150vh]">
      ...
      <div className="px-6 md:px-23 lg:bg-[#f3f4f6] lg:pt-40 lg:px-32">
        ...
        <div>
          <button className="bg-[#ff7a18] text-[#ffffff] text-[1rem] lg:text-[0.9rem] w-full h-[7.5vh] rounded-xl hover:bg-[#ffffff] hover:text-[#ff7a18] hover:cursor-pointer transition duration-500 ease-in-out hover:border-2 hover:border-[#ff7a18] mt-4">
            Continue
          </button>
